...
const generateRandomId = () => {
  ...
  const randomInt = Math.floor(Math.random() * 1000); // Generates a random integer between 0 and 999
...
const ChatBot = (props: Props) => {
  ...
  //     // "https://fin-gpt-production.up.railway.app/navi",
  //     // "http://localhost:8000/navi",
  //     { message, user_id },
  //   );
